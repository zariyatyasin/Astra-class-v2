      ...
      <div className="bg-white shadow rounded-lg">
        <div className="flex flex-row px-2 py-3 mx-3">
          ...
          <div className="flex flex-col mb-2 ml-4 mt-1">
            ...
            <div className="flex w-full mt-1">
              <div className="  text-gray-500 font-base text-xs mr-1 cursor-pointer">
                University of Edu
              </div>
        ...
        <div className="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2">
          <img
            ...
            src="https://images.pexels.com/photos/2170498/pexels-photo-2170498.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          />
        </div>
        <div className="text-base font-medium text-gray-900  mb-2 mx-3 px-2">
          Admission Going on
        </div>
        <div className="text-gray-500 text-sm mb-6 mx-3 px-2">
          Are you ready to embark on an extraordinary academic journey? East
          Delta University is pleased to announce that admissions for the Fall
          2023 semester are now open! Take this golden opportunity to unlock
          your potential and shape your future with us.
        </div>
