...
export const EnrollmantTable = () => {
  return (
    <div className=" overflow-hidden shadow h-96   bg-white rounded-xl">
      <div className="   flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
        <div className="w-full  ">
          <div className="bg-white     ">
            <table className=" w-full  ">
              <thead>
                <tr className=" border-b text-gray-900 uppercase text-sm leading-normal">
