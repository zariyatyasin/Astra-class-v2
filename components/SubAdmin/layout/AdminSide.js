...
const AdminSide = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-10 transition-all ease-in-out border-r duration-300 bg-white h-screen w-64 ${
    ...
    >
      ...
      <div
        className={`absolute   w-full transition-all ease-in-out duration-300  top-0 left-0 h-screen `}
      >
        <div className={`  `}>
          <div
            className={`text-[white] text-3xl font-bold      flex items-center      `}
          >
            <div className=" h-20 w-full border-b border-gray-200">
              <div
                className={`text-[#610621] transition-all ease-in-out  text-xl font-bold  p-2 flex items-center  ${
                  !OpenSidebar && "scale-0"
                }  `}
              >
                East Delta
          ...
          <div className="overflow-y-auto overflow-x-hidden flex-grow">
            <ul className="flex flex-col py-4 space-y-1">
              ...
              <li>
                <Link href="/subadmin/createclass">
              ...
              <li>
                <Link href={"/subadmin/enrollment"}>
                  <div className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    ...
                    <div className="w-2 h-2 rounded-full ml-auto text-xs font-medium tracking-wide   bg-red-400  "></div>
                  </div>
                </Link>
              </li>
              <li className="px-5">
